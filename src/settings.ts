...
export const STORAGE_KEYS = {
  ...
  segmentActionFilter: 'pk.segmentActionFilter',
  ...
  showParkingSpaces: 'pk.showParkingSpaces',
  markedSpacesOnly: 'pk.markedSpacesOnly',
  hideReportedIllegal: 'pk.hideReportedIllegal',
  showInferredCandidates: 'pk.showInferredCandidates',
  useMockLocation: 'pk.useMockLocation',
  favoriteAddresses: 'pk.favoriteAddresses',
  recentAddressSearches: 'pk.recentAddressSearches',
  savedPlans: 'pk.savedPlans',
  tripBoardSortMode: 'pk.tripBoardSortMode',
  tripBoardFilters: 'pk.tripBoardFilters',
  tripBoardIntentFilter: 'pk.tripBoardIntentFilter',
  tripBoardSuggestionFilter: 'pk.tripBoardSuggestionFilter',
  tripBoardCollapsedGroups: 'pk.tripBoardCollapsedGroups',
  recommendationRankMode: 'pk.recommendationRankMode',
  routeProfile: 'pk.routeProfile',
}
