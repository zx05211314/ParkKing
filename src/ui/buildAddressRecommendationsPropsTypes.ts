...
export interface BuildAddressRecommendationsPropsOptions {
  ...
  selectedPaidCurbReferenceId?: AddressRecommendationsProps['selectedPaidCurbReferenceId']
  ...
  onSelectPaidCurbReference?: AddressRecommendationsProps['onSelectPaidCurbReference']
