...
- Live Render deployment verification:
  ...
  This reads `.tmp/render-deployment-handoff.json`, fetches `/api/parking-answer/ready`, and fails if the live service is missing a reviewed district, reports it as not ready, or serves a dataset hash different from the handoff release.
