...
import { formatConsoleSummary, formatMarkdownSummary, writeDiffPackOutputs } from './diffPackOutputs'
import type { PackDiffReport } from './diffPackTypes'

describe('diffPackOutputs', () => {
  ...
  it('formats console and markdown summaries', () => {
    expect(formatConsoleSummary(report)).toContain('Diff summary: 1 added, 0 removed, 1 file changes')
